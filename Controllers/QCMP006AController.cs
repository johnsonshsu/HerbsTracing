...
{
    public class QCMP006AController : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        public IActionResult Init()
        {
            ...
            SessionService.SortColumn = "z_qcm_finish_d.seq";
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_qcm_finish_d model)
        {
