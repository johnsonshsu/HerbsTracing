...
{
    public class QCMP009AController : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "QCMP009"; //預設程式編號
            SessionService.PrgName = "藥材預設檢驗項目"; //預設程式名稱
            SessionService.PageMasterSize = 10; //預設表頭每頁筆數
            SessionService.SearchText = "";
            SessionService.SortColumn = "z_qcm_item_testitem.seq";
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            //取得資料列表集合
            using var sqlData = new sql_z_qcm_item_testitem();
            //農戶(F)且已核准(B)
        ...
        public IActionResult CreateEdit(string id = "")
        {
            ...
            var model = new z_qcm_item_testitem();
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_qcm_item_testitem model)
        {
            ...
            model.parentid = SessionService.CategoryNo;
