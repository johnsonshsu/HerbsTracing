...
{
    public class QCMP003Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.BaseNo = "P";
            SessionService.PrgNo = "QCMP003"; //預設程式編號
            SessionService.PrgName = "產地土壤檢驗記錄"; //預設程式名稱
        ...
        {
            return RedirectToAction(ActionService.Init, "QCMP003A", new { area = ActionService.Area, id = id });
        }
        ...
        public IActionResult Detail(string codeNo , string mno)
        {
            ...
            return RedirectToAction(ActionService.Init, "QCMP003A", new { area = ActionService.Area});
        }
    }
}
