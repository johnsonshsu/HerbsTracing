...
{
    public class QCMP006BController : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        public IActionResult Init()
        {
            ...
            SessionService.SortColumn = "z_qcm_finish_bom.clot_no";
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            string parentInfo = $"檢驗單號：{SessionService.BaseNo}";
            ...
            //取得資料列表集合
            using var sqlData = new sql_z_qcm_finish_bom();
            //農戶(F)且已核准(B)
        ...
        public IActionResult CreateEdit(string id = "")
        {
            ...
            var model = new z_qcm_finish_bom();
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_qcm_finish_bom model)
        {
            ...
            model.form_no = SessionService.BaseNo;
            model.plot_no = SessionService.CategoryNo;
