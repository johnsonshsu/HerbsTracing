...
{
    public class BASP005Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "BASP005"; //預設程式編號
        ...
        {
            return RedirectToAction(ActionService.Init, "BASP005A", new { area = ActionService.Area, id = id });
        }
    }
}
