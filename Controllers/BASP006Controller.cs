...
{
    public class BASP006Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "BASP006"; //預設程式編號
            SessionService.PrgName = "料品主檔資料維護"; //預設程式名稱
        ...
        {
            return RedirectToAction(ActionService.Init, "BASP006A", new { area = ActionService.Area, id = id });
        }
    }
}
