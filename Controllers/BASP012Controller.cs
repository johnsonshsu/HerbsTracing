...
{
    public class BASP012Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "BASP012"; //預設程式編號
            SessionService.PrgName = "食譜基本資料維護"; //預設程式名稱
            SessionService.PageMasterSize = 10; //預設表頭每頁筆數
            SessionService.SearchText = "";
            SessionService.SortColumn = "z_bas_recipes.msort";
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            //取得資料列表集合
            using var sqlData = new sql_z_bas_recipes();
            //農戶(F)且已核准(B)
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_bas_recipes model)
        {
        ...
        {
            return RedirectToAction(ActionService.Init, "BASP012A", new { area = ActionService.Area, id = id });
        }
    }
}
