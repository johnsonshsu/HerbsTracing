...
namespace HerbsTracing.Controllers
{
    public class BASP014Controller : Controller
    {
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "BASP014"; //預設程式編號
            SessionService.PrgName = "影片基本資料維護"; //預設程式名稱
            SessionService.PageMasterSize = 10; //預設表頭每頁筆數
            SessionService.SearchText = "";
            SessionService.SortColumn = "z_bas_video.mdate";
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            //取得資料列表集合
            using var sqlData = new sql_z_bas_video();
            //農戶(F)且已核准(B)
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_bas_video model)
        {
            ...
            model.isenabled = (model.misenabled) ? "True" : "False";
