...
{
    public class QCMP001Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            //農戶(F)且已核准(B)
            var model = sqlData.GetPlaceItemLotDataList(SessionService.SearchText).ToPagedList(id, pageSize);
        ...
        public IActionResult Detail(string id)
        {
            ...
            SessionService.BaseNo = datas[0];
            SessionService.StringValue1 = datas[1];
            SessionService.StringValue2 = datas[2];
            SessionService.StringValue3 = datas[3];
            return RedirectToAction(ActionService.Init, "QCMP001A", new { area = ActionService.Area});
        }
    }
}
