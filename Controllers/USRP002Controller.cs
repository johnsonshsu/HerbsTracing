...
{
    public class USRP002Controller : Controller
    {
        public sql_z_sys_role SqlDatas { get; set; } = new sql_z_sys_role();
        public z_sys_role Model { get; set; } = new z_sys_role();
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "USRP002"; //預設程式編號
            SessionService.PrgName = "角色基本資料維護"; //預設程式名稱
            SessionService.PageMasterSize = 10; //預設表頭每頁筆數
            SessionService.SearchText = "";
            SessionService.SortColumn = "z_sys_role.msort,z_sys_role.mno";
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            //取得資料列表集合
            //using var sqlData = new sql_z_sys_role();
            //農戶(F)且已核准(B)
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_sys_role model)
        {
           ...
           // using var sqlData = new sql_z_sys_role();
            ...
            model.isenabled = (model.isenable) ? "True" : "False";
