...
{
    public class SYSP003Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "SYSP003"; //預設程式編號
            SessionService.PrgName = "手機讀取條碼統計圖"; //預設程式名稱
