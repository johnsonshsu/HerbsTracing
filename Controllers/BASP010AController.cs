...
{
    public class BASP010AController : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "BASP010A"; //預設程式編號
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            string parentInfo = $"農戶：{SessionService.BaseNo} {SessionService.BaseName} / 產地：{SessionService.CategoryNo} {SessionService.CategoryName} ";
            ...
            //農戶(F)且已核准(B)
            var model = sqlData.GetUserPlaceDataList(SessionService.BaseNo, SessionService.CategoryNo, SessionService.SearchText).ToPagedList(id, pageSize);
        ...
        public IActionResult CreateEdit(z_qcm_environment model)
        {
            ...
            //執行新增或修改資料
            using var sqlItem = new sql_z_qcm_environment();
            using var sqlData = new sql_z_qcm_environment();
