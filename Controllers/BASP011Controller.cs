...
{
    public class BASP011Controller : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        {
            //這裏可以寫入初始程式
            SessionService.PrgNo = "BASP011"; //預設程式編號
            SessionService.PrgName = "客戶基本資料維護"; //預設程式名稱
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            //農戶(F)且已核准(B)
            var model = sqlData.GetDataListByCode("V" , SessionService.SearchText).ToPagedList(id, pageSize);
        ...
        {
            return RedirectToAction(ActionService.Init, "BASP011A", new { area = ActionService.Area, id = id });
        }
    }
}
