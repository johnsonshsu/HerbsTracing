...
{
    public class QCMP002AController : Controller
    {
        /// <summary>
        /// 資料初始事件
        /// </summary>
        ...
        public IActionResult Init()
        {
            ...
            SessionService.SortColumn = "z_qcm_environment_d.mno";
        ...
        public IActionResult Index(int id = 1)
        {
            ...
            string parentInfo = $"檢驗單號：{SessionService.CategoryNo}";
            ...
            //農戶(F)且已核准(B)
            var model = sqlData.GetDataList(SessionService.BaseNo, SessionService.CategoryNo, SessionService.SearchText).ToPagedList(id, pageSize);
        ...
        public IActionResult CreateEdit(string id = "")
        {
            ...
            var model = new z_qcm_environment_d();
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult CreateEdit(z_qcm_environment_d model)
        {
